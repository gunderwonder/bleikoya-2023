...
<head>
	...
	<!-- Jost: fallback for Futura (Mac/iOS has Futura built-in) -->
	<!-- Libre Franklin: body font -->
	<link href="https://fonts.googleapis.com/css2?family=Jost:wght@400;500;600;700&family=Libre+Franklin:ital,wght@0,400;0,500;0,700;1,400;1,700&display=swap" rel="stylesheet">
